package com.sharmokh.mongorecipeapp.bootstrap;

import com.sharmokh.mongorecipeapp.model.*;
import com.sharmokh.mongorecipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        log.debug("Let's get some recipes.");
    ...
    private List<Recipe> getRecipes() {
        ...
        // Refactored to setRecipe in setNotes
