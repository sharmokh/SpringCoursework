...
public class ImageController {
    ...
    @GetMapping("recipe/{id}/images")
    private String uploadNewImagePage(@PathVariable String id, Model model) {
        model.addAttribute("recipe", recipeService.findCommandById(Long.valueOf(id)));
        return "recipe/image_form";
    }

    @PostMapping("recipe/{id}/images")
    private String postImage(@PathVariable String id, @RequestParam("imagefile") MultipartFile file) {
